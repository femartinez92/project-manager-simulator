...
class StakeholdersControllerTest < ActionController::TestCase
  ...
  test "should create stakeholder" do
    assert_difference('Stakeholder.count') do
      post :create, stakeholder: { commitment_level: @stakeholder.commitment_level, influence: @stakeholder.influence, name: @stakeholder.name, power: @stakeholder.power }
    end
  ...
  test "should update stakeholder" do
    patch :update, id: @stakeholder, stakeholder: { commitment_level: @stakeholder.commitment_level, influence: @stakeholder.influence, name: @stakeholder.name, power: @stakeholder.power }
    assert_redirected_to stakeholder_path(assigns(:stakeholder))
  end
