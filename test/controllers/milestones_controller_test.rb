...
class MilestonesControllerTest < ActionController::TestCase
  ...
  test "should create milestone" do
    assert_difference('Milestone.count') do
      post :create, milestone: { description: @milestone.description, due_date: @milestone.due_date, name: @milestone.name }
    end
  ...
  test "should update milestone" do
    patch :update, id: @milestone, milestone: { description: @milestone.description, due_date: @milestone.due_date, name: @milestone.name }
    assert_redirected_to milestone_path(assigns(:milestone))
  end
